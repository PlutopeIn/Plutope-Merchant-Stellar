...
import editCustomizeStoreController from './useEditCustomizeStore';
import styles from './editCustomizeStore.style';
import {Button, CustomStatusBar, Dropdown, Header} from '@components';
import SvgIndex from '@svgIndex';

const EditCustomizeStore: React.FC = () => {
  const {
    storeDetail,
    uploadPhoto,
    validation,
...
export default EditCustomizeStore;
