...
import kycController from './useKyc';
import styles from './kyc.style';
import {
  Button,
  CountryNameModal,
  CustomStatusBar,
...
import {documentType} from './kyc.const';
    ...
    <View style={styles.container}>
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          />
          <TouchableOpacity
            onPress={() => setKycDetail('showDatePicker', true)}>
            <Input
          ...
          <DateTimePickerModal
            isVisible={kycDetail.showDatePicker}
